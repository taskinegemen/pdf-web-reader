    ...
    for (i=0; i<indicesToDisplay.length; i++) {
        ...
        if (BookReader.util.notInArray(indicesToDisplay[i], this.displayedIndices)) {            
            ...
            $(div).click(function(e) {
                ...
                var ofs  = e.clientX - posx.left;
                var ofs1 = e.clientY - posx.right;
                console.log(ofs+' '+ofs1);
            });
    ...
    return $([
        '<div class="BRfloat" id="BRinfo">',
            ...
            '<div class="BRfloatFoot">',
                '<a href="http://www.linden-tech.com">Linden Web Reader Hakkında</a>',
            '</div>',
        '</div>'].join('\n')
    );
}
    ...
    return $([
        '<div class="BRfloat" id="BRshare">',
            '<div class="BRfloatHead">',
                'Share',
                '<a class="floatShut" href="javascript:;" onclick="$.fn.colorbox.close();"><span class="shift">Kapat</span></a>',
            '</div>',
        '</div>'].join('\n')
    );
}
...
BookReader.prototype.initUIStrings = function()
{
    ...
    var titles = { '.logo': 'Linden Tech', // $$$ update after getting OL record
                   '.zoom_in': 'Zoom in',
                   '.zoom_out': 'Zoom out',
                   '.onepg': 'One-page view',
                   '.twopg': 'Two-page view',
